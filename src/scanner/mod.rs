...
pub use downloads::{
    scan_downloads, DownloadCategory, DownloadItem, DownloadsScanOptions, DownloadsScanResult,
};
...
pub use walker::{scan_directories, scan_directory, total_size, ScanOptions, ScannedItem};
